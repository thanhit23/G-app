          ...
          <div className="pt-4 px-6 pb-[10px]">
            <div className="flex justify-between items-center mb-4">
              <div className="space-y-1">
                <h1 className="text-2xl font-bold">米咖</h1>
                <p className="text-base text-gray-400">clc._688</p>
              </div>
              <Avatar className="h-20 w-20 rounded-full">
                <AvatarImage
                  src="https://miro.medium.com/v2/resize:fit:1400/format:webp/1*xrYKieEfN_JLAweDrQMEVA.png"
                  alt="Profile"
                />
            ...
            <div className="flex justify-between items-center">
              <div className="mb-4">
                <p className="text-grey-3 text-[15px]">28,9K người theo dõi</p>
              </div>
